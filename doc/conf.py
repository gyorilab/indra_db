...
MOCK_MODULES = [
    ...
    'sqlalchemy', 'sqlalchemy.ext', 'sqlalchemy.ext.declarative', 'sqlalchemy.engine', 'sqlalchemy.engine.url',
    'sqlalchemy.orm', 'sqlalchemy.orm.attributes', 'sqlalchemy.dialects', 'sqlalchemy.exc',
