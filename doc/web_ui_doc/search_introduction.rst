...
- Relation type: the type of Statement e.g. Activation, Phosphorylation, DecreaseAmount,
  ...
  `INDRA documentation <https://indra.readthedocs.io/en/latest/modules/Statements.html>`_.
...
- Context filter (MeSH): Enter the name or identifier of a :strong:`Me`dical :strong:`S`ubject
  :strong:`H`eadings (MeSH) term that the papers retrieved as evidence are
...
.. figure:: ../web_ui_results_expanded.png
   ...
   Search results view with three levels of nesting expanded all
